    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('pxjg', '培训学校'), ('gr', '个人'), ('gx', '高校')], default='pxjg', max_length=20, verbose_name='学校类别')),
                ('desc', models.TextField(verbose_name='学校描述')),
                ('tag', models.CharField(default='全国知名', max_length=10, verbose_name='学校标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.CourseOrg', verbose_name='所属学校')),
            ],
            options={
                'verbose_name': '教师',
